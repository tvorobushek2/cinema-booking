...
API описан в файле \[api.yaml](api.yaml). Основные эндпоинты:
...
\- `GET /api/sessions/{id}/seats/` — схема зала
...
\- `POST /api/bookings/{id}/pay/` — оплатить

\- `POST /api/bookings/{id}/extend/` — продлить



\### Форматы дат:

\- Все даты в формате ISO 8601: `2026-07-10T18:00:00Z`
